    ...
    <div class="collapse navbar-collapse" id="myMenu">
      <ul class="navbar-nav pl-5 custom-nav">
        ...
        if (isset($_SESSION['is_login'])) {
          ...
          echo '          <li class="nav-item custom-nav-item"><a href="#login"class="nav-link" data-toggle="modal" data-target="#adminLoginModalCenter"> Admin Login</a></li> ';
        }
        ?>

        <li class="nav-item custom-nav-item"><a href="#Contact" class="nav-link">Contact</a></li>
        <!-- <li class="nav-item custom-nav-item"><a href="#login" class="nav-link" data-toggle="modal"
            data-target="#adminLoginModalCenter"> Admin Login</a></li> -->
      </ul>
    </div>
  </nav> <!-- End Navigation -->